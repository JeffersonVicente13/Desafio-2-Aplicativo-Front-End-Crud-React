...
import Logo from '../../components/logo/logoJV.png';
...
function Login() {
    ...
    return (
        ...
        <div className="logo"> 
            ...
            <img src={Logo} alt="Logo JV System" />
    ...
    <footer>
        <div id="copyright">
            Desenvolvido por <a href="https://github.com/JeffersonPVicente/JeffersonPVicente" target="_blank">@JeffersonPVicente</a> durante o curso de Análise e Desenvolimento de Sistemas © 2024
        </div>
    </footer>
